...
- [ ] `Notification` (REST, Message Broker, CockroachDB, JAVA, spring)
    - [ ] Create notification 
    - [ ] Delete notification


- [ ] `History` (GraphQL, NodeJS, Typescript)
